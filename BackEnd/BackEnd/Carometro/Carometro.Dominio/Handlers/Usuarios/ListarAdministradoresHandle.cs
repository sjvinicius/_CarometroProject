...
{
    public class ListarAdministradoresHandle : IHandlerQuery<ListarUsuariosQuery>
    {
        private readonly IUsuarioRepositorio _usuarioRepositorio;

        public ListarAdministradoresHandle(IUsuarioRepositorio usuarioRepositorio)
        {
        ...
        {
            var usuarios = _usuarioRepositorio.ListarAdmin();
